                                ...
                                <div class="row">
                                    <div class="col-md-8 p-4">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="media">
                                                <img class="d-flex mr-3" src="<?php echo base_url(); ?>assets/images/users/1.jpg" width="60"
                                            ...
                                            <li class="media my-4">
                                                <img class="d-flex mr-3" src="<?php echo base_url(); ?>assets/images/users/2.jpg" width="60"
                                                    alt="Generic placeholder image">
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-1">List-based media object</h5> Cras sit amet
                                                    nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                                            ...
                                            <li class="media">
                                                <img class="d-flex mr-3" src="<?php echo base_url(); ?>assets/images/users/3.jpg" width="60"
                                                    alt="Generic placeholder image">
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-1">List-based media object</h5> Cras sit amet
                                                    nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                                                    ...
                                                    <div class="media mt-3">
                                                        <a class="d-flex pr-3" href="javascript:void(0)">
                                                            <img src="<?php echo base_url(); ?>assets/images/users/4.jpg" width="60"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            <img class="mr-3 img-fluid w-25" src="<?php echo base_url(); ?>assets/images/big/img1.jpg"
                                                alt="Generic placeholder image">
                                            <div class="media-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            <img class="mr-3 w-25" src="<?php echo base_url(); ?>assets/images/big/img1.jpg"
                                                alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h5 class="mt-0">Media heading</h5> Cras sit amet nibh libero, in
                                                gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus
                                                ...
                                                <div class="media mt-3">
                                                    <a class="pr-3 w-25" href="#">
                                                        <img src="<?php echo base_url(); ?>assets/images/big/img1.jpg" class="w-100"
                                                            alt="Generic placeholder image">
                                                    </a>
                                                    <div class="media-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            <img class="align-self-start w-25 mr-3" src="<?php echo base_url(); ?>assets/images/big/img1.jpg"
                                                alt="Generic placeholder image">
                                            <div class="media-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            <img class="align-self-center w-25 mr-3" src="<?php echo base_url(); ?>assets/images/big/img1.jpg"
                                                alt="Generic placeholder image">
                                            <div class="media-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            <img class="align-self-end mr-3 w-25" src="<?php echo base_url(); ?>assets/images/big/img1.jpg"
                                                alt="Generic placeholder image">
                                            <div class="media-body">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            ...
                                            <img class="ml-3 w-25" src="<?php echo base_url(); ?>assets/images/big/img1.jpg"
                                                alt="Generic placeholder image">
                                        </div>
                                    </div>
                                </div>
