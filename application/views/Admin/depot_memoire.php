        ...
        <div class="scroll-sidebar" data-sidebarbg="skin6">
          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                <a class="sidebar-link" href="stages-ac.html" aria-expanded="false"
                            ...
                            <div class="card-body">
                               ...
                               <!-- <div class="card">
                                <div class="card-header"> -->
                                    <h2 class="card-title">Déposer mon mémoire</h2>
                                <!-- </div> -->
                                <!-- <div class="card-body"> -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="nom_entreprise" style="margin-bottom: 10px;">Nom de l'entreprise</label>
                                                       <input type="text" name="nom_entreprise" id="nom_entreprise" class="form-control" placeholder="Nom de l'entreprise" required="required" autofocus="autofocus" style="margin-bottom: 15px;">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="ville" style="margin-bottom: 10px;">Ville</label>
                                                       <input type="text" name="ville" id="ville" class="form-control" placeholder="Ville" required="required" autofocus="autofocus" style="margin-bottom: 15px;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="theme" style="margin-bottom: 10px;">Theme de travail</label>
                                                       <input type="text" name="theme" id="theme" class="form-control" placeholder="Thene de travail" required="required" autofocus="autofocus" style="margin-bottom: 15px;">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="encadreurPro" style="margin-bottom: 10px;">Encadreur professionnel</label>
                                                       <input type="text" name="encadreurPro" id="encadreurPro" class="form-control" placeholder="Encadreur professionnel" required="required" autofocus="autofocus" style="margin-bottom: 15px;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" >
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="encadreurAca" style="margin-bottom: 10px;">Encadreur academique</label>
                                                       <input type="text" name="encadreurAca" id="encadreurAca" class="form-control" placeholder="Encadreur academique" required="required" autofocus="autofocus" style="margin-bottom: 15px;">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="memoire" style="margin-bottom: 10px;">Enregistrer le memoire</label>
                                                        <input type="file" name="memoire" id="memoire" class="form-control" placeholder="Enregistrer le memoire" required="required" autofocus="autofocus" style="margin-bottom: 15px;" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button class="btn btn-success" style="display: block; border-radius: 10px;" type="submit">Enregistrer</button>
                                    </form>
                                </div>
                               </div>
