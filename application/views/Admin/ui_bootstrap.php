                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mb-4">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/images/big/img1.jpg" alt="image"
                                    ...
                                    <div class="col-lg-4 text-center mb-4">
                                        ...
                                        <h6 class="card-subtitle"><code>.rounded-circle</code> Make sure the image is
                                            square
                                            not ractangle</h6>
                                        <img src="<?php echo base_url(); ?>assets/images/users/5.jpg" alt="image" class="rounded-circle"
                                            width="290">
                                        <p class="mt-3 mb-0">
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/images/users/5.jpg" alt="image" class="img-thumbnail"
                                            width="290">
                                        <p class="mt-3 mb-0">
                                    </div>
                                    <div class="col-12">
