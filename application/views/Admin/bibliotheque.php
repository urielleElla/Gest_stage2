            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="de_temps.html"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme1.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme1.html">Application de gestion du materiel de l'IUT</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme2.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme2.html">Application de gestion des salles de l'IUT</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme3.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme3.html">Application de gestion des enfants de la rue</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme4.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme4.html">Gestion des patients: hopital regional de NGAOUNDERE</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme5.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme5.html">Application de gestion des salles de l'EGCIM</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme6.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme6.html">Gestion du reseau telephonique de l'IUT</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme7.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme7.html">Installation et programmation des cameras de surveillance</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme8.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme8.html">Mise sur pied d'un reseau telephonique a l'ENSAI</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme9.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme9.html">Mise sur pied d'un reseau telephonique AU CDTIC</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme10.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme10.html">Gestion de la programmation des chambres d'hotel: grand chateau</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme11.html"> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme11.html">Application de gestion de la clientelle de MTN</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="theme12.html"> <i class=""></i> </a>
                                            </div>
                                            <div class="card-body">
                                                <span style="font-size: 14px;"><a href="theme12.html">applicationsde gestion des emploies de temps a l'IUT</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
