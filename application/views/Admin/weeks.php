            ...
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Stage academique </span></a
                >
              </li>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center mb-4">
                    <h4 class="card-title">Semaines précédentes</h4>
                    <div class="ml-auto">
                  ...
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="grid-container">
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°1</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°5</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°9</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°13</h4></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-3">
                      <div class="grid-container">
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N*2</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N*6</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                        ...
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N*14</h4></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-3">
                      <div class="grid-container">
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°3</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°7</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°11</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°15</h4></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-3">
                      <div class="grid-container">
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°4</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°8</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°12</h4></a>
                          </div>
                        </div>
                        <div class="card">
                          <div class="card-body">
                            <a href="semaine10.html"><h4>Semaine N°16</h4></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="card">
                        <div class="card-header">
                          <a href="time-table.html">Semaine en cours</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
