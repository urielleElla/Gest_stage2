                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="grid-container">
                            <a href="list-enterprise.html" class="zoom">
                              <div class="card text-center">
                                <i
                                  class="far fa-check-circle fa-4x text-success mt-4"
                                ></i>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                          <div class="grid-container">
                            <a href="contact_entreprise.html" class="zoom">
                              <div class="card text-center">
                                <i
                                  class="far fa-comment fa-4x mt-4 text-primary"
                                ></i>
                                <div class="card-body">
                                  <h5 class="card-title text-uppercase">
