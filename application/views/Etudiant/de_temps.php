                            ...
                            <div class="">                                        
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="semaines" style="margin-left: 25px; font-weight: bold; font-size: 24;">Voir les semaines precedentes</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="evenements" style="margin-left: 25px; font-weight: bold; font-size: 24;">Evenements</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
